...
public class Global extends GlobalSettings {
    ...
    public void onStart(Application app) {//作为系统启动后的第一次请求调用
        try {
            Request request = new Request.Builder().url(play.Play.application().configuration().getString("message.server.url") + "/client/schedule/" + Codecs.md5("hmm-100901".getBytes())).build();
